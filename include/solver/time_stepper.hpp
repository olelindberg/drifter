...
private:
    ...
    static constexpr std::array<Real, 5> A = {0.0, -0.4178904745, -1.192151694643,
                                               -1.697784692471, -1.514183444257};
    static constexpr std::array<Real, 5> B = {0.1496590219993, 0.3792103129999,
                                               0.8229550293869, 0.6994504559488,
                                               0.1530572479681};
...
public:
    AdaptiveTimeController(Real cfl_target = 0.5,
                           Real dt_min = 1.0e-10,
                           Real dt_max = 1.0e6);
...
public:
    ...
    void step(Real t, Real dt, VecX& U,
