...
public:
    ...
    void set_attribute(const std::string& var_name,
    ...
    void write_timestep(size_t time_idx, Real time,
                        const OctreeAdapter& mesh,
...
public:
    ...
    OceanOutputWriter(const std::string& path, const OctreeAdapter& mesh,
