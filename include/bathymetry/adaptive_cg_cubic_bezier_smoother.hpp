...
/// @brief Adaptive CG cubic Bezier bathymetry smoother with error-driven refinement
///
/// Iteratively solves the CG cubic Bezier smoothing problem and refines elements
