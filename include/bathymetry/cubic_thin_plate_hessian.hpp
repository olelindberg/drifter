...
/// @brief Thin plate spline energy functional for cubic Bezier surface regularization
///
...
///
/// For a cubic Bezier surface z(u,v) = sum_k c_k * B_k(u,v), the thin plate energy is:
...
public:
    ...
    ///
    /// For an element with dimensions (dx, dy), applies proper derivative scaling.
    ///
