...
// element's polynomial at boundary faces, rather than independently sampled values.
//
...
/// @brief Project coarse element data onto fine elements at non-conforming interfaces
///
...
/// element's polynomial. This ensures continuity when using Bernstein interpolation.
///
...
void project_coarse_to_fine_2d(
    ...
    std::vector<VecX>& element_data,
    int order,
    SeabedInterpolation method);

/// @brief Project coarse element data onto fine elements at non-conforming interfaces (3D)
///
