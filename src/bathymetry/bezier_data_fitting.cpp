...
void BezierDataFittingAssembler::set_from_bathymetry_source(const BathymetrySource &source,
                                                            int ngauss) {
...
void BezierDataFittingAssembler::set_from_function(std::function<Real(Real, Real)> bathy_func,
                                                   int ngauss) {
