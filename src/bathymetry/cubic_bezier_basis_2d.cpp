...
Vec2 CubicBezierBasis2D::control_point_position(int dof) const {
    int i, j;
    dof_ij(dof, i, j);
...
VecX CubicBezierBasis2D::evaluate_bernstein_1d(int n, Real t) const {
    VecX B(n + 1);
    ...
    // Build up to degree n using de Casteljau recurrence
...
VecX CubicBezierBasis2D::evaluate(Real u, Real v) const {
...
VecX CubicBezierBasis2D::evaluate_du(Real u, Real v) const {
...
VecX CubicBezierBasis2D::evaluate_dv(Real u, Real v) const {
    VecX Bu = evaluate_bernstein_1d(DEGREE, u);
...
MatX CubicBezierBasis2D::evaluate_gradient(Real u, Real v) const {
    VecX Bu = evaluate_bernstein_1d(DEGREE, u);
    VecX Bv = evaluate_bernstein_1d(DEGREE, v);
    VecX dBu = evaluate_bernstein_derivative_1d(DEGREE, u, 1);
    VecX dBv = evaluate_bernstein_derivative_1d(DEGREE, v, 1);
...
VecX CubicBezierBasis2D::evaluate_d2u(Real u, Real v) const {
...
VecX CubicBezierBasis2D::evaluate_d2v(Real u, Real v) const {
    VecX Bu = evaluate_bernstein_1d(DEGREE, u);
...
VecX CubicBezierBasis2D::evaluate_d2uv(Real u, Real v) const {
    VecX dBu = evaluate_bernstein_derivative_1d(DEGREE, u, 1);
    VecX dBv = evaluate_bernstein_derivative_1d(DEGREE, v, 1);
...
int CubicBezierBasis2D::corner_dof(int corner_id) const {
    // Corner mapping (in parameter space [0,1]^2):
    // 0: (0, 0) -> i=0, j=0 -> DOF 0
    // 1: (1, 0) -> i=3, j=0 -> DOF 12
    // 2: (0, 1) -> i=0, j=3 -> DOF 3
...
std::vector<int> CubicBezierBasis2D::edge_dofs(int edge_id) const {
