            ...
            for (int k = 0; k < n1d; ++k) {
                for (int j = 0; j < n1d; ++j) {
                    for (int i = 0; i < n1d; ++i) {
                        ...
                        if (face_id == 0 && i == 0) on_face = true;
                        else if (face_id == 1 && i == n1d-1) on_face = true;
                        else if (face_id == 2 && j == 0) on_face = true;
                        else if (face_id == 3 && j == n1d-1) on_face = true;
                        ...
                        Real projected_value = interp.evaluate_scalar_2d(coarse_2d, coarse_xi, coarse_eta);
